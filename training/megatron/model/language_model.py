...
def get_language_model(num_tokentypes, add_pooler,
                       ...
                       pre_process=True, post_process=True, pos_emb_type = "learn"):
...
class Embedding(MegatronModule):
    ...
    def __init__(self,
        ...
        if pos_emb_type == "learn":
            ...
            raise NotImplementedError(f"pos_emb_type '{pos_emb_type}' is not implement yet")
        ...
        if self.add_encoder:
            if args.retro_add_retriever:
                ...
                self.encoder = ParallelTransformer(
                    self.init_method,
                    output_layer_init_method, pos_emb_type=self.pos_emb_type,
