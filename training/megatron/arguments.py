...
def _add_training_args(parser):
    ...
    group.add_argument('--ul2-type', type=str, default="sample",
                       help='Wether use ul2, use which ul2'
                       '  --ul2-type <sample>'
                       '             <batch>'
                       '             <no>   ')
    group.add_argument('--pos-emb-type', type=str, default="learn",
                       help='position embedding type'
                       '  --ul2-type <learn>'
                       '             <rotary>   ')
    group.add_argument('--mlp-type', type=str, default="origin",
                       help='Use which mlp'
                       '  --mlp-type <origin>'
                       '             <SwiGLU>')
