...
def training_log(loss_dict, total_loss_dict, learning_rate, iteration,
    ...
    if iteration % args.log_interval == 0:
        ...
        flops, _, _ = throughput_calculator(args, elapsed_time_per_iteration, 1)
        token_speed = args.global_batch_size * 568 / (elapsed_time_per_iteration)

        log_string += ' Teraflops: {:1f} |'.format(
           flops)
        log_string += ' token_speed(568 seq_len): {:1f} |'.format(
           token_speed)
